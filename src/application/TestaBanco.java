...
//	BLOCO DE DECLARA��O E INSTANCIA��O DE OBJETOS TESTE
		   Curso curso1 = new Curso(123, "ADS");
		   Curso curso2 = new Curso(321, "Computa��o");
...
//	INSTANCIANDO OS DAOS ATRAV�S DA DAO FACTORY
 ...
 * (partes de atualiza��o est�o comentadas para efeito de visualiza��o das altera��es dos dados
 * no momento da apresenta��o do projeto)
 * */ 
		   
		   System.out.println("\n--------- TENTANDO CADASTRAR PESSOAS J� CADASTRADAS ---------");
		   ...
		   System.out.println("\n\n--------- TENTANDO CADASTRAR ALUNOS EM CURSOS N�O CADASTRADOS ---------");
		   ...
		   System.out.println("\n>>> TENTANDO EXCLUIR COM CPF N�O CADASTRADO:");
		   if(professorDao.remover("005")) {
			   System.out.println("Excluido!");
		   }else{
			   System.out.println("IMPOSSIVEL EXCLUIR - N�O ENCONTRADO");
		   }
...
//		   }
		   ...
		   System.out.println("\n>>> TENTANDO ATUALIZAR CURSO PARA CURSO N�O CADASTRADO");
...
//		   System.out.println("\n>>> TENTANDO ATUALIZAR CURSO V�LIDO");
...
//		   System.out.println("\n\n---------- ADICIONANDO AJUSTE NO SAL�RIO DOS PROFs ----------");
//		   professorDao.ajusteSalarial(5);
		   

		   System.out.println("\n\n---------- TESTE TABELA CURSO ----------");
		   
		   System.out.println("\n>>> TENTANDO INSERIR CURSO J� CADSATRADO");
