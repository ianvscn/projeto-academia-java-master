 ...
 *		@author: Grupo 2 -
	...
	CLASSE DE TESTE PARA OS REPOSIT�RIOS VERS�O ARRAY E LISTA
* */
...
//  BLOCO DE EXIBI��O DE TESTES		
		...
		System.out.println("\n\n---------- TESTE DE REMO��O, INSER��O E EXIBI��O ----------");

		System.out.println("\n>>>>> LISTA DE PESSOAS ANTES DA REMO��O <<<<<<");
		rep.exibir();
		...
		if (rep.procurar("005") == null)
			System.out.println("N�O ENCONTRADO! APAGOU!");
		else
			System.out.println("ENCONTRADO! N�O APAGOU!");
